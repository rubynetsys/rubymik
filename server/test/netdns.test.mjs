...
const localClosed = { resolverIp: '192.168.88.2', resolverNet: 'direct', lanInterfaces: ['bridge-lan'], exemptions: [], failMode: 'closed', fallbackUpstream: '', blockDoh: false };

test('local resolver, fail-closed, no exemptions/DoH — exact object set', () => {
